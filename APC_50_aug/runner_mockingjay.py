...
def get_mockingjay_args():
    ...
    parser.add_argument('--dckpt', default='apc_phone_libri_sd1337/apc_phone-208000.ckpt', type=str, help='path to downstream checkpoint.', required=False)
    parser.add_argument('--apc_path', default='./result/result_apc/apc_libri_sd1337/apc-250000.ckpt', type=str, help='path to the apc model checkpoint.', required=False)
    # mockingjay
