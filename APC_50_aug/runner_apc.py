...
class get_apc_config():
    def __init__(self, seed=1337):
        ...
        self.total_steps = 250000 # Number of training steps
        ...
        self.data_path = 'data/libri_mel80_subword500' # Path to the preprocessed librispeech directory 
        self.train_set = ['train-clean-50-aug'] 
